...
function $s_Lcafe_App__main__AT__V(args) {
  $m_Lcafe_App$().main__AT__V(args)
}
/** @constructor */
function $c_Lcafe_App$() {
  /*<skip>*/
}
$c_Lcafe_App$.prototype = new $h_O();
$c_Lcafe_App$.prototype.constructor = $c_Lcafe_App$;
/** @constructor */
function $h_Lcafe_App$() {
  /*<skip>*/
}
$h_Lcafe_App$.prototype = $c_Lcafe_App$.prototype;
$c_Lcafe_App$.prototype.main__AT__V = (function(args) {
  document.addEventListener("DOMContentLoaded", ((arg1$2) => {
    $m_Lcafe_App$().cafe$App$$$anonfun$main$1__Lorg_scalajs_dom_Event__V(arg1$2)
  }))
});
$c_Lcafe_App$.prototype.cafe$App$$$anonfun$main$4__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V = (function(e, canvasCtx$1, chair1$1) {
  canvasCtx$1.drawImage($n(chair1$1).sr_ObjectRef__f_elem, 73.0, 125.0, 42.0, 42.0)
});
$c_Lcafe_App$.prototype.cafe$App$$$anonfun$main$3__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V = (function(e, canvasCtx$1, chair1$1) {
  canvasCtx$1.drawImage($n(chair1$1).sr_ObjectRef__f_elem, 60.0, 120.0, 50.0, 50.0);
  document.createElement("img");
  $n(chair1$1).sr_ObjectRef__f_elem.src = "assets/person.png";
  $n(chair1$1).sr_ObjectRef__f_elem.onload = ((arg1$2) => {
    $m_Lcafe_App$().cafe$App$$$anonfun$main$4__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V(arg1$2, canvasCtx$1, chair1$1)
  })
});
$c_Lcafe_App$.prototype.cafe$App$$$anonfun$main$6__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V = (function(e, canvasCtx$1, coffee$1) {
  canvasCtx$1.drawImage($n(coffee$1).sr_ObjectRef__f_elem, 110.0, 100.0, 42.0, 42.0)
});
$c_Lcafe_App$.prototype.cafe$App$$$anonfun$main$5__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V = (function(e, canvasCtx$1, table1$1) {
  canvasCtx$1.drawImage($n(table1$1).sr_ObjectRef__f_elem, 110.0, 120.0, 50.0, 50.0);
  var elem = document.createElement("img");
  var coffee = new $c_sr_ObjectRef(elem);
  coffee.sr_ObjectRef__f_elem.src = "assets/coffee.png";
  coffee.sr_ObjectRef__f_elem.onload = ((arg1$2) => {
    $m_Lcafe_App$().cafe$App$$$anonfun$main$6__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V(arg1$2, canvasCtx$1, coffee)
  })
});
$c_Lcafe_App$.prototype.cafe$App$$$anonfun$main$2__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V = (function(e, canvasCtx$1, background$1) {
  canvasCtx$1.drawImage($n(background$1).sr_ObjectRef__f_elem, 0.0, 0.0, 325.0, 225.0);
  var elem = document.createElement("img");
  var chair1 = new $c_sr_ObjectRef(elem);
  chair1.sr_ObjectRef__f_elem.src = "assets/chair.png";
  chair1.sr_ObjectRef__f_elem.onload = ((arg1$2) => {
    $m_Lcafe_App$().cafe$App$$$anonfun$main$3__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V(arg1$2, canvasCtx$1, chair1)
  });
  var elem$1 = document.createElement("img");
  var table1 = new $c_sr_ObjectRef(elem$1);
  table1.sr_ObjectRef__f_elem.src = "assets/table.png";
  table1.sr_ObjectRef__f_elem.onload = ((arg1$2$1) => {
    $m_Lcafe_App$().cafe$App$$$anonfun$main$5__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V(arg1$2$1, canvasCtx$1, table1)
  })
});
$c_Lcafe_App$.prototype.cafe$App$$$anonfun$main$1__Lorg_scalajs_dom_Event__V = (function(e) {
  ...
  var elem = document.createElement("img");
  var background = new $c_sr_ObjectRef(elem);
  background.sr_ObjectRef__f_elem.src = "assets/background.png";
  background.sr_ObjectRef__f_elem.onload = ((arg1$2) => {
    $m_Lcafe_App$().cafe$App$$$anonfun$main$2__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_CanvasRenderingContext2D__sr_ObjectRef__V(arg1$2, canvasCtx, background)
  })
});
var $d_Lcafe_App$ = new $TypeData().initClass({
  Lcafe_App$: 0
}, false, "cafe.App$", {
  Lcafe_App$: 1,
  O: 1
});
$c_Lcafe_App$.prototype.$classData = $d_Lcafe_App$;
var $n_Lcafe_App$;
function $m_Lcafe_App$() {
  if ((!$n_Lcafe_App$)) {
    $n_Lcafe_App$ = new $c_Lcafe_App$()
  };
  return $n_Lcafe_App$
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lcafe_App__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
